...
This project focuses on analyzing and visualizing global happiness data using Python libraries such as Pandas, Matplotlib, and Seaborn. The goal is to explore trends, relationships, and regional patterns in happiness scores and their contributing factors.

📊 Objectives

The notebook includes the following analytical tasks:
